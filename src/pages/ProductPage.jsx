  ...
  return (
    <div className="min-h-screen bg-[#FFF6E5] pt-24 pb-16 px-6">
      {useSEO({
        ...
        image: product.image,
        url: `https://callejeroburger.cl/producto/${product.id}`,
      })}
      ...
      >
        <div className="flex flex-col md:flex-row">
          ...
          >
            <div>
              {/* Categoría */}
              <span className="text-xs font-bold uppercase tracking-widest text-red-400 bg-red-50 px-3 py-1 rounded-full">
                {product.category}
              </span>
              ...
              <p className="text-4xl font-extrabold text-red-600 mt-6">
